...
public class DatabaseData {
    ...
    public void fillDatabase() {
        if (carsService.getAllCars().size() == 0) {
            ...
            carsService.add(new Car("S-Class", "Mercedes-Benz", "седан", 2023, 40000,
            ...
            carsService.add(new Car("G-90", "Genesis", "седан", 2023, 30000, 370,
            ...
            carsService.add(new Car("S-90", "Volvo", "седан", 2022, 42000, 310,
            ...
            carsService.add(new Car("A8", "Audi", "седан", 2022, 38000, 330,
            ...
            carsService.add(new Car("A3", "Audi", "седан", 2022, 32000, 320,
            ...
            carsService.add(new Car("Panamera", "Porsche", "седан", 2022, 45000, 380,
            ...
            carsService.add(new Car("Integra", "Acura", "седан", 2021, 27000, 290,
            ...
            carsService.add(new Car("A4", "Audi", "седан", 2022, 36000, 360,
            ...
            carsService.add(new Car("i4", "BMW", "седан", 2022, 48000, 370,
            ...
            carsService.add(new Car("S-60", "Volvo", "седан", 2023, 28000, 300,
            ...
            carsService.add(new Car("4 Series", "BMW", "кабріолет", 2022, 50000, 320,
            ...
            carsService.add(new Car("G70", "Genesis", "седан", 2023, 40000, 380,
            ...
            carsService.add(new Car("3 series", "BMW", "седан", 2023, 60000, 390,
            ...
            carsService.add(new Car("Giulia", "Alpha Romeo", "седан", 2023, 39000, 350,
            ...
            carsService.add(new Car("CT4", "Cadillac", "седан", 2023, 52000, 340,
            ...
            carsService.add(new Car("CLA", "Mercedes-Benz", "седан", 2022, 53000, 330,
            ...
            carsService.add(new Car("2 Series", "BMV", "седан", 2022, 44000, 310,
